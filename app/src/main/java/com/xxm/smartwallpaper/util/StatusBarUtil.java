    ...
    public static boolean translucentStatusBar(Window window) {
        try {
            ...
            if (Build.VERSION.SDK_INT >= 23) {
                Class var11 = WindowManager.LayoutParams.class;
                int var12 = var11.getField("FLAG_TRANSLUCENT_STATUS").getInt(var11);
                int var13 = var11.getField("FLAG_DRAWS_SYSTEM_BAR_BACKGROUNDS").getInt(var11);
                int var15 = e.getField("SYSTEM_UI_FLAG_LAYOUT_FULLSCREEN").getInt(e);
                value = e.getField("SYSTEM_UI_FLAG_LAYOUT_STABLE").getInt(e);
                Window var17 = window;
                var17.clearFlags(var12);
                var17.getDecorView().setSystemUiVisibility(var15 | value);
                var17.addFlags(var13);
                Method var19 = Window.class.getMethod("setStatusBarColor", new Class[]{Integer.TYPE});
                var19.invoke(window, new Object[]{Integer.valueOf(0)});
                return true;
            }

            Field field;
            if (Build.VERSION.SDK_INT >= 19) {
                WindowManager.LayoutParams var10 = window.getAttributes();
                field = var10.getClass().getField("FLAG_TRANSLUCENT_STATUS");
                window.addFlags(field.getInt(var10));
                return true;
            }
            ...
            if (Build.VERSION.SDK_INT >= 14) {
                ...
                for (int method = 0; method < value; ++method) {
                    Field args1 = c[method];
                    if (args1.getName().equals("SYSTEM_UI_FLAG_TRANSPARENT_BACKGROUND")) {
                        field = args1;
                        break;
                    }
                }
                ...
                if (field != null) {
                    Class var14 = field.getType();
                    if (var14 == Integer.TYPE) {
                        value = field.getInt((Object) null);
                        Method var16 = view.getClass().getMethod("setSystemUiVisibility", new Class[]{Integer.TYPE});
                        Object[] var18 = new Object[]{Integer.valueOf(value)};
                        var16.invoke(view, var18);
                        return true;
                    }
                }
            }
