...
/**
 * Created by xuqunxing on 2018/9/1.
 */
...
public class XPermissionUtils {
    ...
    public static String[] permissionArr = new String[] { Manifest.permission.CAMERA,Manifest.permission.READ_PHONE_STATE,Manifest.permission.WRITE_EXTERNAL_STORAGE,Manifest.permission.READ_EXTERNAL_STORAGE };
    ...
    public static void requestSuspensionWindow(final Context context){
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M) {
