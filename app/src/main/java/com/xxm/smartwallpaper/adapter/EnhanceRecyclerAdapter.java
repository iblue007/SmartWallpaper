...
import com.xxm.smartwallpaper.inteface.OnPullToRefreshListener;
import com.xxm.smartwallpaper.loader.LoadAsyncRunnable;
import com.xxm.smartwallpaper.loader.OnTaskProcessListener;
...
//    private LoadAsyncRunnable<T> mAsyncRunnable;
...
//                    Log.d("cxydebug", "---onScrolled: " + totalItemCount);
//                    Log.d("cxydebug", "onScrolled: " + visibleItemCount);
//                    Log.d("cxydebug", "onScrolled: " + firstVisibleItem);
//                    Log.d("cxydebug", "onScrolled: " + visibleThreshold);
//                    Log.d("cxydebug", "onScrolled: " + isLoading());
//                    Log.d("cxydebug", "===onScrolled: " + end());
//                    Log.d("cxydebug", "\n\n");
...
//        int code;
//        if (result != null && result.getCsResult().isRequestOK()) {
//            code = ResultCodeMap.SERVER_RESPONSE_CODE_SUCCESS;
//            final List<T> list = result.itemList;
//            if (list != null) {
//                if (!list.isEmpty()) {
//                    if (forMore) {
//                        addData(list);
...
//        } else {
//            rollbackPage();
//            code = result == null ? ResultCodeMap.RESULT_CODE_EXCEPTION : result.getCsResult().getResultCode();
//        }
//        return code;
//    }
