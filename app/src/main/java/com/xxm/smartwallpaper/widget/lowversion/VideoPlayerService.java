...
public class VideoPlayerService extends Service implements IServiceHelper {
    ...
    public static ExoVideoView mFloatPlayerUI;
    ...
    public void initWindowFloatView() {
        RelativeLayout.LayoutParams params = new RelativeLayout.LayoutParams(
                ...
                ViewGroup.LayoutParams.MATCH_PARENT);
        mFloatPlayerUI = new ExoVideoView(mActivity);
        ...
        wmParams.width = width;//getResources().getDimensionPixelSize(R.dimen.float_window_root_width);
        wmParams.height = height;//getResources().getDimensionPixelSize(R.dimen.float_window_root_height);
        wmParams.x = 0;//(width - wmParams.width) / 2;
        wmParams.y = 0;//(height - wmParams.height) / 2;
        wmParams.alpha = 0.5f;// 1.0f;
